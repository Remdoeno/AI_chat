# Generated by splitting app.py lines 102-257. Keep execution order in qwen_app/startup/loader.py.
...
MEMORY_COMPRESS_MAX_TOKENS = int(os.environ.get("QWEN_MEMORY_COMPRESS_MAX_TOKENS", "1200"))
...
MEMORY_JUDGE_MAX_TOKENS = int(os.environ.get("QWEN_MEMORY_JUDGE_MAX_TOKENS", "1600"))
MEMORY_GATE_TIMEOUT = float(os.environ.get("QWEN_MEMORY_GATE_TIMEOUT", "8"))
MEMORY_GATE_MAX_TOKENS = int(os.environ.get("QWEN_MEMORY_GATE_MAX_TOKENS", "512"))
MEMORY_VALIDATION_TIMEOUT = float(os.environ.get("QWEN_MEMORY_VALIDATION_TIMEOUT", "20"))
MEMORY_VALIDATION_MAX_TOKENS = int(os.environ.get("QWEN_MEMORY_VALIDATION_MAX_TOKENS", "1200"))
...
MEMORY_AGENT_MAX_TOKENS = int(os.environ.get("QWEN_MEMORY_AGENT_MAX_TOKENS", "2400"))
MEMORY_AGENT_REPAIR_MAX_TOKENS = int(os.environ.get("QWEN_MEMORY_AGENT_REPAIR_MAX_TOKENS", "1800"))
...
MEMORY_AGENT_ACTIVE_WAIT_SECONDS = float(os.environ.get("QWEN_MEMORY_AGENT_ACTIVE_WAIT_SECONDS", "1.0"))
...
MEMORY_DEDUPE_AGENT_MAX_TOKENS = int(os.environ.get("QWEN_MEMORY_DEDUPE_AGENT_MAX_TOKENS", "3600"))
...
MEMORY_REFINE_AGENT_ENABLED = env_bool("QWEN_MEMORY_REFINE_AGENT_ENABLED", True)
MEMORY_REFINE_AGENT_MIN_RUN_INTERVAL_SECONDS = float(os.environ.get("QWEN_MEMORY_REFINE_AGENT_MIN_RUN_INTERVAL_SECONDS", "1200"))
MEMORY_REFINE_AGENT_MIN_CHARS = int(os.environ.get("QWEN_MEMORY_REFINE_AGENT_MIN_CHARS", "90"))
MEMORY_REFINE_AGENT_MAX_CANDIDATES = int(os.environ.get("QWEN_MEMORY_REFINE_AGENT_MAX_CANDIDATES", "2"))
MEMORY_REFINE_AGENT_MAX_TOKENS = int(os.environ.get("QWEN_MEMORY_REFINE_AGENT_MAX_TOKENS", "3000"))
MEMORY_REFINE_AGENT_TEMPERATURE = float(os.environ.get("QWEN_MEMORY_REFINE_AGENT_TEMPERATURE", "0.1"))
MEMORY_REFINE_AGENT_TOP_P = float(os.environ.get("QWEN_MEMORY_REFINE_AGENT_TOP_P", "0.8"))
MEMORY_REFINE_AGENT_TIMEOUT = float(os.environ.get("QWEN_MEMORY_REFINE_AGENT_TIMEOUT", "90"))
HIDDEN_CHARACTER_AGENT_ENABLED = env_bool("QWEN_HIDDEN_CHARACTER_AGENT_ENABLED", True)
HIDDEN_CHARACTER_AGENT_CONTEXT_MESSAGES = int(os.environ.get("QWEN_HIDDEN_CHARACTER_AGENT_CONTEXT_MESSAGES", "10"))
HIDDEN_CHARACTER_AGENT_RECENT_IMAGES = int(os.environ.get("QWEN_HIDDEN_CHARACTER_AGENT_RECENT_IMAGES", "8"))
HIDDEN_CHARACTER_AGENT_MAX_CONTEXT_CHARS = int(os.environ.get("QWEN_HIDDEN_CHARACTER_AGENT_MAX_CONTEXT_CHARS", "9000"))
HIDDEN_CHARACTER_AGENT_MAX_TOKENS = int(os.environ.get("QWEN_HIDDEN_CHARACTER_AGENT_MAX_TOKENS", "2200"))
HIDDEN_CHARACTER_AGENT_TEMPERATURE = float(os.environ.get("QWEN_HIDDEN_CHARACTER_AGENT_TEMPERATURE", "0.1"))
HIDDEN_CHARACTER_AGENT_TOP_P = float(os.environ.get("QWEN_HIDDEN_CHARACTER_AGENT_TOP_P", "0.8"))
HIDDEN_CHARACTER_AGENT_TIMEOUT = float(os.environ.get("QWEN_HIDDEN_CHARACTER_AGENT_TIMEOUT", "90"))
HIDDEN_CHARACTER_CHAT_CONTEXT_LIMIT = int(os.environ.get("QWEN_HIDDEN_CHARACTER_CHAT_CONTEXT_LIMIT", "4"))
HIDDEN_CHARACTER_ARTIFACT_CONTEXT_LIMIT = int(os.environ.get("QWEN_HIDDEN_CHARACTER_ARTIFACT_CONTEXT_LIMIT", "8"))
HIDDEN_ARTIFACT_DIRECTIVE_AGENT_ENABLED = env_bool("QWEN_HIDDEN_ARTIFACT_DIRECTIVE_AGENT_ENABLED", True)
HIDDEN_ARTIFACT_DIRECTIVE_AGENT_CONTEXT_MESSAGES = int(os.environ.get("QWEN_HIDDEN_ARTIFACT_DIRECTIVE_AGENT_CONTEXT_MESSAGES", "8"))
HIDDEN_ARTIFACT_DIRECTIVE_AGENT_MAX_CONTEXT_CHARS = int(os.environ.get("QWEN_HIDDEN_ARTIFACT_DIRECTIVE_AGENT_MAX_CONTEXT_CHARS", "7000"))
HIDDEN_ARTIFACT_DIRECTIVE_AGENT_MAX_TOKENS = int(os.environ.get("QWEN_HIDDEN_ARTIFACT_DIRECTIVE_AGENT_MAX_TOKENS", "1800"))
HIDDEN_ARTIFACT_DIRECTIVE_AGENT_TEMPERATURE = float(os.environ.get("QWEN_HIDDEN_ARTIFACT_DIRECTIVE_AGENT_TEMPERATURE", "0.1"))
HIDDEN_ARTIFACT_DIRECTIVE_AGENT_TOP_P = float(os.environ.get("QWEN_HIDDEN_ARTIFACT_DIRECTIVE_AGENT_TOP_P", "0.8"))
HIDDEN_ARTIFACT_DIRECTIVE_AGENT_TIMEOUT = float(os.environ.get("QWEN_HIDDEN_ARTIFACT_DIRECTIVE_AGENT_TIMEOUT", "75"))
HIDDEN_ARTIFACT_DIRECTIVE_CHAT_CONTEXT_LIMIT = int(os.environ.get("QWEN_HIDDEN_ARTIFACT_DIRECTIVE_CHAT_CONTEXT_LIMIT", "5"))
HIDDEN_ARTIFACT_DIRECTIVE_ARTIFACT_CONTEXT_LIMIT = int(os.environ.get("QWEN_HIDDEN_ARTIFACT_DIRECTIVE_ARTIFACT_CONTEXT_LIMIT", "10"))
...
IDLE_AGENT_MAX_TOKENS = int(os.environ.get("QWEN_IDLE_AGENT_MAX_TOKENS", "24000"))
