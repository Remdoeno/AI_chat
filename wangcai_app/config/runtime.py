# Generated by splitting app.py lines 1-72. Keep execution order in wangcai_app/startup/loader.py.
import hmac
import asyncio
import base64
import hashlib
...
from typing import Any, AsyncGenerator, Callable, Dict, Generator, Iterable, List, Optional, Tuple
...
DB_PATH = Path(os.environ.get("WANGCAI_WEB_DB", DATA_DIR / "chat_history.sqlite3"))
AUTH_CONFIG_PATH = Path(os.environ.get("WANGCAI_AUTH_CONFIG", DATA_DIR / "admin_auth.json"))
