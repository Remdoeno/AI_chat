...
MODEL_PROVIDER_PRESETS: Dict[str, Dict[str, object]] = {
    ...
    "hidream": {
        ...
        "base_url": os.environ.get("WANGCAI_IMAGE_MODEL_BASE_URL", "http://127.0.0.1:8002").strip(),
        "model": os.environ.get("WANGCAI_IMAGE_MODEL_NAME", IMAGE_MODEL_DISPLAY_NAME).strip(),
        "api_key": os.environ.get("WANGCAI_IMAGE_MODEL_API_KEY", "").strip(),
        "use_proxy": False,
        "proxy_url": "",
    },
}
