...
class StaticRegressionTests(unittest.TestCase):
    ...
    def test_frontend_has_search_activity_region_and_handlers(self):
        ...
        self.assertIn("20260610_wangcai_1_3", html)
        self.assertIn("/static/app.js?v=20260610_wangcai_1_3", html)
    ...
    def test_memory_admin_login_dialog_spacing_and_buttons_match(self):
        ...
        self.assertIn("/static/styles.css?v=20260610_wangcai_1_3", html)
    ...
    def test_desktop_analysis_send_button_aligns_to_textarea_row(self):
        ...
        self.assertIn("/static/analysis.css?v=20260610_wangcai_1_3", html)
        self.assertIn("/static/analysis.css?v=20260610_wangcai_1_3", analysis_login)
        self.assertIn("@media (min-width: 761px)", css)
    ...
    def test_identity_labels_use_device_instead_of_ip(self):
        ...
        self.assertIn("20260610_wangcai_1_3", analysis_login)
